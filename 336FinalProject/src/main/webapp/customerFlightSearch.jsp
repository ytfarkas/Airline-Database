...
<body>
	...
	<form action="searchFlight.jsp" method="post">
		...
		Sort By: <select name="sort">
			...
			<option value="Departure_Time ASC">Departure Time - Earliest</option>
			<option value="Departure_Time DESC">Departure Time - Latest</option>
			<option value="Arrival_Time ASC">Landing Time - Earliest</option>
			<option value="Arrival_Time DESC">Landing Time - Latest</option>
			
		</select><br/><br/>
		Filter By:<br/>
		Airline ID: <input type="text" name="filterAirline"><br/>
		Max Price: $<input type="number" name="maxPrice">

		<div id="search">
			<input type="hidden" name="location" value="customer"> <input
